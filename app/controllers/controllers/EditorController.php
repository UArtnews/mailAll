...
class EditorController extends \BaseController
{
    ...
    public function route($instanceName, $action = null, $subAction = null){
		...
		$parameters['data']['h1fontsize'] = $util->getTweakableByParam("publication-h2-font-size", $parameters['data']['tweakables']);	
		$parameters['data']['h1fontweight'] = $util->getTweakableByParam("publication-h2-font-weight", $parameters['data']['tweakables']);
		$parameters['data']['h1style'] = ' Style="color: ' . $parameters['data']['h1color'] . '; font-size: ' . $parameters['data']['h1fontsize'] . ';  font-weight: bold; "';
		//print($parameters['data']['h1style']);
